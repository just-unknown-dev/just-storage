...
///
/// The default implementation is [EncryptedFileStorage], which uses
/// AES-256-GCM authenticated encryption with a per-write random nonce and a
/// master key stored in the app's private sandbox.  Use this wherever
/// sensitive data (credentials, tokens, PII) must be persisted.
///
/// Use [JustStorage.encrypted] to obtain an instance — no `path_provider`
